...
public class OrderController {
    ...
    @PostMapping("/orders")
    public ResponseEntity<Response> insert(@RequestBody OrderRequest orderRequest, UriComponentsBuilder uriBuilder) {
        Order order = orderService.insertOrder(orderRequest.getCarTypeId(), orderRequest.getOrderStatusId());
